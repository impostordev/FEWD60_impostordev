...
if (!empty($_GET['q'])) {
	...
	$connection = new tmhOAuth(array(
	  ...
	  'consumer_key'    => $sIxA4M695NqC3y14dUsWXYzq7,
	  // 'consumer_secret' => $consumer_secret,
	  'consumer_secret' => $gCs0A6GFNXZHjWMzM0Y27bzG8pTcyfpUM3EWPcjIqE2sPgNULf,
	  // 'user_token'      => $user_token,
	  'user_token'      => $2799228886-vLJJcok9kVeAJOwHXGCV6pOuAkzupXUOhY5sSwy,
	  // 'user_secret'     => $user_secret
	  'user_secret'     => $Wdu5fbonJB8wcBrYhk0VLXj5PtFmdo39etdvZDaMGxlBQ
	));
